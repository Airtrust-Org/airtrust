...
-- in D1 revision data (not used as runtime code fallback). Use a VALUES CTE
-- instead of a long UNION ALL compound SELECT: remote D1 enforces a lower
-- compound-term ceiling than local SQLite for this query shape.
WITH x(parameter_key, numeric_value, unit, window_kind, direction) AS (
  VALUES
  ('FRMS_V2_ENABLED', 1.0, 'boolean', NULL, NULL),
  ('LANDINGS_NEUTRAL_MAX', 8, 'landing', NULL, NULL),
  ('LANDINGS_PENALTY_PER_EXCESS', 0.5, 'point/landing', NULL, 'DECREASE_EFFECTIVENESS'),
  ('LANDINGS_PENALTY_CAP_POINTS', 4, 'point', NULL, 'CAP'),
  ('TEMP_BAND1_MIN_C', 30, 'celsius', NULL, NULL),
  ('TEMP_BAND2_MIN_C', 32, 'celsius', NULL, NULL),
  ('TEMP_BAND3_MIN_C', 34, 'celsius', NULL, NULL),
  ('TEMP_BAND4_MIN_C', 36, 'celsius', NULL, NULL),
  ('TEMP_BAND1_DELTA_POINTS', -0.5, 'point', NULL, 'DECREASE_EFFECTIVENESS'),
  ('TEMP_BAND2_DELTA_POINTS', -1, 'point', NULL, 'DECREASE_EFFECTIVENESS'),
  ('TEMP_BAND3_DELTA_POINTS', -1.5, 'point', NULL, 'DECREASE_EFFECTIVENESS'),
  ('TEMP_BAND4_DELTA_POINTS', -2, 'point', NULL, 'DECREASE_EFFECTIVENESS'),
  ('TEMP_PENALTY_CAP_POINTS', 2, 'point', NULL, 'CAP'),
  ('IMC_VISIBILITY_THRESHOLD_M', 5000, 'meter', NULL, NULL),
  ('IMC_CEILING_THRESHOLD_FT', 1500, 'foot', NULL, NULL),
  ('IMC_DEPARTURE_DELTA_POINTS', -0.5, 'point/event', NULL, 'DECREASE_EFFECTIVENESS'),
  ('IMC_ARRIVAL_DELTA_POINTS', -0.75, 'point/event', NULL, 'DECREASE_EFFECTIVENESS'),
  ('IMC_LEG_CAP_POINTS', 1, 'point', NULL, 'CAP'),
  ('IMC_DAY_CAP_POINTS', 3, 'point', 'DAY', 'CAP'),
  ('RECOVERY_HOTEL_MAX_POINTS', 4, 'point/day', 'DAY', 'RECOVERY'),
  ('RECOVERY_ONSITE_MAX_POINTS', 1.5, 'point/day', 'DAY', 'RECOVERY'),
  ('RECOVERY_IMMEDIATE_CALLOUT_MULTIPLIER', 0.75, 'ratio', NULL, 'RECOVERY'),
  ('RECOVERY_NO_WORK_MIN_HOURS', 12, 'hour', 'DAY', 'RECOVERY'),
  ('RECOVERY_ABSOLUTE_REST_MIN_HOURS', 4, 'hour', 'DAY', 'RECOVERY'),
  ('RECOVERY_ABSOLUTE_REST_MID_HOURS', 6, 'hour', 'DAY', 'RECOVERY'),
  ('RECOVERY_ABSOLUTE_REST_FULL_HOURS', 8, 'hour', 'DAY', 'RECOVERY'),
  ('RECOVERY_ABSOLUTE_REST_LOW_FACTOR', 0.5, 'ratio', NULL, 'RECOVERY'),
  ('RECOVERY_ABSOLUTE_REST_MID_FACTOR', 0.75, 'ratio', NULL, 'RECOVERY'),
  ('HV_CREDIT_THRESHOLD_MINUTES', 120, 'minute', 'DAY', 'RECOVERY'),
  ('HV_CREDIT_MAX_POINTS', 2, 'point', 'D+1', 'RECOVERY'),
  ('HV_NEUTRAL_MAX_MINUTES', 420, 'minute', 'DAY', NULL),
  ('HV_PENALTY_PER_EXCESS_HOUR_POINTS', 2, 'point/hour', 'DAY', 'DECREASE_EFFECTIVENESS'),
  ('HV_PENALTY_CAP_POINTS', 4, 'point', 'DAY', 'CAP'),
  ('PRESENTATION_NIGHT_START_HOUR', 22, 'hour', 'DAY', NULL),
  ('PRESENTATION_NIGHT_END_HOUR', 2, 'hour', 'DAY', NULL),
  ('PRESENTATION_NIGHT_DELTA_POINTS', -0.5, 'point', 'DAY', 'DECREASE_EFFECTIVENESS'),
  ('ACCUMULATION_WINDOW_MODE', 0, 'enum:0_calendar,1_rolling,2_custom', NULL, NULL),
  ('ACCUMULATION_USE_MONTH_CALENDAR', 1, 'boolean', 'MONTH_CALENDAR', NULL),
  ('ACCUMULATION_USE_YEAR_CALENDAR', 1, 'boolean', 'YEAR_CALENDAR', NULL),
  ('ACCUMULATION_USE_28D_ROLLING', 0, 'boolean', 'ROLLING_28D', NULL),
  ('ACCUMULATION_USE_365D_ROLLING', 0, 'boolean', 'ROLLING_365D', NULL)
)
INSERT INTO frms_config_parameters (
  id, revision_id, parameter_key, numeric_value, json_value, unit, metric,
  window_kind, direction, required, created_at
