...
export function normalizeSigvoosRecord(raw: Record<string, unknown>): SigvoosNormalizedLeg | null {
  ...
  return {
    ...
    staffIdSigvoos: legContext.staffIdSigvoos,
    flightReportId: legContext.flightReportId,
    legNumber: legContext.legNumber,
    departureIcao: legContext.departureIcao,
    arrivalIcao: legContext.arrivalIcao,
    engineStartTime: legContext.engineStartTime,
    takeoffTime: legContext.takeoffTime,
    landingTime: legContext.landingTime,
    engineShutoffTime: legContext.engineShutoffTime,
