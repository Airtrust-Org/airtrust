...
const TARGETS = [
  new URL('../../routes/lms-relatorios-scorm-pagination.test.ts', import.meta.url).pathname,
  new URL('../../repositories/lmsRelatoriosRepository.ts', import.meta.url).pathname,
];
