-- Migration 0415: Adicionar tipo_treinamento e carga_horaria à VIEW qualificacoes_historico_v
-- Motivo: A coluna "Modalidade" no frontend usa getTipoTreinamentoDisplay(),
-- que depende de tipo_treinamento. Sem essa coluna na VIEW, o frontend sempre mostra "Periódico".
-- Data: 2026-07-03
