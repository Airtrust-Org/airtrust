...
-- Migration one-shot: colunas não existem em produção. Idempotência garantida pelos
-- índices (CREATE INDEX IF NOT EXISTS). ALTER TABLE sem IF NOT EXISTS compatível com D1.
