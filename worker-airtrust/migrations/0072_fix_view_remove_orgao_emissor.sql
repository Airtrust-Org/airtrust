-- 0072_fix_view_remove_orgao_emissor.sql
-- Remove referências a coluna inexistente qh.orgao_emissor na view qualificacoes_historico_v
-- Substitui por constantes 'Indefinido'
