-- 0076_recreate_view_qualificacoes_historico_enriched.sql
-- Recria view qualificacoes_historico_v com colunas enriquecidas e derivadas dinamicamente.
-- Usa joins mínimos e calcula status a partir de data_vencimento ou validade_meses.
