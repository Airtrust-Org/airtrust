-- ============================================================
-- MIGRATION 0066: Ajustes View + Trigger Soft Delete
-- Data: 2025-11-22
-- Objetivo:
--  1. Adicionar alias 'validade' na view para compatibilidade com buscarComDependencias.
--  2. Recriar trigger trg_funcionarios_soft_delete sem referência a sessoes_simulador
--     (schema remoto divergente) para evitar erro 'no such column'.
-- ============================================================
...
SELECT
  ...
  qh.validade AS validade, -- alias compat
  CASE
...
-- Recriar trigger soft delete sem sessoes_simulador
