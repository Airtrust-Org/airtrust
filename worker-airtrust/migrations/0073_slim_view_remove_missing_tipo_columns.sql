-- 0073_slim_view_remove_missing_tipo_columns.sql
-- Remove colunas inexistentes de qualificacoes_tipos na view qualificacoes_historico_v
-- Colunas removidas: requer_renovacao, obrigatoria_para_cargo, pre_requisitos, cor_status, icone, ordem_exibicao
...
SELECT 
  ...
  'Indefinido' AS qualificacao_orgao_emissor,
  'Indefinido' AS historico_orgao_emissor,
