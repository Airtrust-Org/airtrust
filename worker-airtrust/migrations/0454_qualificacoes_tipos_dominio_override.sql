...
-- change does not presume to have — it must go through
-- scripts/apply-migration-production.sh (for the DDL) followed by the
-- administrative classification tool (for the actual per-tipo values),
-- never a manual remote UPDATE.
--
