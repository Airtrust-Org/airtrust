-- ================================================================
-- Migration 0241: View lógica do estado operacional de tripulantes
-- ================================================================
-- Fonte única de verdade para leituras operacionais em Escalas.
-- Habilitações por modelo continuam sendo enriquecidas no helper TS,
-- pois o schema legado usa modelo_aeronave_id textual/combinado.
