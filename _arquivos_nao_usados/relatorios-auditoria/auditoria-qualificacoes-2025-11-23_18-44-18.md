...
**Taxa de Sucesso:** 69% (60 de 86 testes)
...
Arquivo existe (1762 linhas). Rotas de qualificações
...
HTTP 200 (esperado: 200) em 490ms

### ⚠️ Listar Certificados - Performance
Resposta aceitável: 490ms
...
HTTP 200 (esperado: 200) em 450ms

### ⚠️ Documentos Pasta Virtual - Performance
Resposta aceitável: 450ms
...
Arquivo muito grande (1762 linhas) - considerar refatoração
