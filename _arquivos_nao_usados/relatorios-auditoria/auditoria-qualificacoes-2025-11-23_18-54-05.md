...
HTTP 200 (esperado: 200) em 249ms

### ✅ Listar Tipos - Performance
Resposta rápida: 249ms
...
HTTP 200 (esperado: 200) em 358ms

### ⚠️ Listar Funcionários - Performance
Resposta aceitável: 358ms

### ✅ Listar Funcionários - JSON
Response é JSON válido

### ✅ Detalhe Tipo - Status Code
HTTP 200 (esperado: 200) em 232ms

### ✅ Detalhe Tipo - Performance
Resposta rápida: 232ms
...
### ⚠️ Paginação - Página 1
Status 500 (não crítico)

### ⚠️ Paginação - Página 2
Status 500 (não crítico)

### ⚠️ Paginação - Página 3
Status 500 (não crítico)
