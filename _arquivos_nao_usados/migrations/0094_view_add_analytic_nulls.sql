-- Migration 0094: Adiciona campos analíticos esperados pela rota (nota, instrutor, local_treinamento, modalidade, carga_horaria) como NULL
-- Facilita compatibilidade até backfill real.
...
SELECT
  ...
  qh.arquivo_url,
  -- Campos analíticos esperados (NULL placeholders)
  NULL AS nota,
  NULL AS instrutor,
