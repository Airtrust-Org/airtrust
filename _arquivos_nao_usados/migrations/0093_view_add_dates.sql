-- Migration 0093: Adiciona aliases data_validade (calculada) e data_conclusao (NULL) à view
-- Compatibilidade com rota que seleciona qh.data_validade e qh.data_conclusao
