...
INSERT INTO _0449rb_models (role, modelo_id)
...
JOIN modelos_sessao_versionamento msv
 ...
 AND msv.empresa_id = (SELECT empresa_id FROM _0449rb_tenant)
...
INSERT INTO _0449rb_quals (role, qual_id)
SELECT role, qt.id FROM (
...
JOIN qualificacoes_tipos qt
 ...
 AND qt.empresa_id = (SELECT empresa_id FROM _0449rb_tenant)
