...
| `MIG-01` - Migration Integrity | READY_FOR_CONTROLLED_REBASELINE_AFTER_DQ | `DQ-01` já foi executado e validado em `staging`; o rebaseline agora depende apenas do pacote próprio de `MIG-01` | materializar snapshot/rollback/approval/safe-command de `MIG-01` e executar janela separada | GPT-5.5 Altissimo |
