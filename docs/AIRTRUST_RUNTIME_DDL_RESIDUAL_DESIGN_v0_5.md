...
| Migrations novas necessarias | 0 novas para apply imediato; resta remover bootstrap de `R04` e reconciliar a cadeia limpa de `R01` |
| Ordem recomendada restante | `R04` remocao de bootstrap -> `R01` baseline/chain plan |
| Status na matriz | DDL_RUNTIME = PARTIAL (R03 = RESOLVED; R09 = RESOLVED Sprint R09; R04 = MIGRATION_APPLIED_PENDING_RUNTIME_REMOVAL Sprint R04.5; R01 = 0387_APPLIED_IN_PRODUCTION_BUT_CHAIN_0354_STILL_NEEDS_RECONCILIATION) |
