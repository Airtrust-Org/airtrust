...
**Modo:** Roadmap atualizado após Sprint S writer/dual-write mínimo. Sem migration remota, backfill ou alteração manual de dados reais.
...
**Estado atual:** sem P0/P1 ativos em código de produção; o Audit Trail/LGPD v2 está `DUAL_WRITE_PARTIAL`, com writer e integração LMS prontos, mas schema/flag/paridade operacional ainda pendentes.
...
### Item 6 — Audit Trail/LGPD v2 writer ✅ DUAL_WRITE_PARTIAL

- **Status:** Sprint R versionou `audit_events_v2`; Sprint S criou writer canônico e dual-write mínimo em cursos LMS atrás de flag.
...
- **Escopo consolidado até o Sprint S:** contrato v2, migration aditiva, writer com metadata allowlist, testes de schema/writer, integração LMS, phased plan e rollback plan.
...
## Ordem de execução recomendada (atualizada após Sprint S)
...
| 8 | Platform roles schema + RBAC dual-read foundation | Curto prazo | Cliente externo | GPT-5.5 Altissimo |
...
**Fim do roadmap.** Documento atualizado em 2026-06-03 com base na matriz consolidada de 48 achados.
