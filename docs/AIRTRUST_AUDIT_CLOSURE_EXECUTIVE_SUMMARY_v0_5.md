...
| **Migration Integrity** | Sprint AH congelou a governança local, Sprint AI fechou a estratégia de rebaseline controlado, Sprint AK adicionou contrato/runbook/gate e `DQ-01` já foi executado e validado em `staging` | Próxima janela grande: materializar pacote próprio de `MIG-01` e executar o rebaseline controlado |
...
2. **Materializar o pacote próprio de `MIG-01`** com snapshot/rollback/approval/safe-command.
