...
6. **DDL runtime residual** em SIGVOOS e documentos. R03 = RESOLVED (Sprint X.5: `0386` aplicada + deploy). R09 = RESOLVED (Sprint R09: ALTER TABLE removido de `shared.ts`). R04 = RESOLVED (Sprint R04.7: deploy Worker/API + smoke pós-deploy PASS). R01 = READY_FOR_RUNTIME_FALLBACK_REMOVAL.
