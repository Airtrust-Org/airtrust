...
6. **DDL runtime residual** em SIGVOOS e documentos. R03 = RESOLVED (Sprint X.5: `0386` aplicada + deploy). R09 = RESOLVED (Sprint R09: ALTER TABLE removido de `shared.ts`). R04 = READY_FOR_0388_CANONICAL_WITH_PROBE_BASELINE (Sprint R04.2: probe remoto em produção com `PRAGMA` only, baseline parcial/legada confirmada). R01 = MIGRATION_CHAIN_BLOCKED_BY_0354 (Sprint Z1.1).
...
5. **Fechar o bloco DDL residual restante** na ordem `R04 -> R01`, mantendo a abordagem conservadora para schema/migrations. R09 = RESOLVED (Sprint R09). R04 = READY_FOR_0388_CANONICAL_WITH_PROBE_BASELINE (Sprint R04.2). Próximo passo: criar/testar/aplicar `0388_documentos_canonical_schema.sql` sobre a baseline remota já capturada.
