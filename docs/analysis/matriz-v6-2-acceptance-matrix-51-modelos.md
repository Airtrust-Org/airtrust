...
| `A139-REQ-01` | Reaquisição de Experiência Recente | Periódico | AW139 | 18 | 15 | target 51 fechado | sim | sim | sim | não aplicável | sim | GO com ressalva | sem rebalanceamento do bloco final de emergências nesta etapa; correção final limitada a hardening/overrides textuais, com decisão pedagógica do owner ainda pendente |
