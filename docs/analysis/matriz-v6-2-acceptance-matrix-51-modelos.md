...
| `A139-NOT-01` | AW139 - TREINAMENTO NOTURNO - ONSHORE | Periódico | AW139 | 18 | 15 | target 51 fechado | sim | sim | sim | não aplicável | sim | GO | incorporado ao target 51 (Decisão 15); 18 técnicas preservadas do snapshot operacional |
| `A139-NOT-02` | AW139 - TREINAMENTO NOTURNO - OFFSHORE | Periódico | AW139 | 18 | 15 | target 51 fechado | sim | sim | sim | sim | sim | GO | incorporado ao target 51 (Decisão 15); 18 técnicas preservadas do snapshot operacional |
...
Esta matriz elimina a falsa sensacao de fechamento criada por validar apenas o subconjunto consolidado. O target V6.2 fica fechado em `51/918/15`, com `TRE-INST`, `CRED-EXA` e os `10` modelos de noturno/reaquisicao/semestral incluidos (Decisao 15). `SK76-S-02/02` recebeu a correcao da Decisao 16 e `S76-NOT-02` recebeu a correcao da Decisao 17. Nenhuma manobra foi apagada, nenhuma ficha/sessao/avaliacao/historico foi tocado, e a lista de manobras ativas sem uso permanece para recalculo em etapa posterior a este fechamento.
