...
| RBAC-02 | RBAC_SUPORTE | Role `support` read-only por tenant inexistente | S1 | READY_FOR_CONTROLLED_SCHEMA_MIGRATION | Sprint P definiu `support_read_only`; Sprint Q fechou a readiness; a etapa atual versionou `0389_platform_roles_support_access_foundation.sql` com grants/sessoes auditaveis e helper local de dual-read; `MIG-01` agora deixou baseline controlado validado para o apply da `0389` | `0389` local-only, MIG01 Controlled Rebaseline | — | Docs `AIRTRUST_RBAC_SUPPORT_V2_DESIGN_v0_5.md`, `AIRTRUST_SUPPORT_READ_ONLY_MODEL_v0_5.md`, `AIRTRUST_AUDIT_V2_RBAC_SUPPORT_SCHEMA_READINESS_v0_5.md`, `AIRTRUST_MIG01_CONTROLLED_REBASELINE_EXECUTION_RESULT_AND_0389_HANDOFF_v0_5.md`, testes `platform-roles-support-access-schema.test.ts` e `platform-access.test.ts` | Falta apply controlado da `0389`, dual-read em ambiente aprovado e enforcement runtime gradual | Aplicar `0389` em janela controlada | GPT-5.5 Altissimo |
| RBAC-03 | RBAC_SUPORTE | `platform_admin` persistido ausente | S1 | READY_FOR_CONTROLLED_SCHEMA_MIGRATION | Sprint P definiu o modelo conceitual; a etapa atual versionou a fundacao local `0389` com `user_platform_roles` e helper de resolucao persistida + fallback legado; `MIG-01` agora deixou baseline controlado validado para o apply da `0389` | `0389` local-only, MIG01 Controlled Rebaseline | — | Docs `AIRTRUST_PLATFORM_ROLES_MODEL_v0_5.md`, `AIRTRUST_RBAC_V2_MIGRATION_PLAN_v0_5.md`, `AIRTRUST_AUDIT_V2_RBAC_SUPPORT_SCHEMA_READINESS_v0_5.md`, `AIRTRUST_MIG01_CONTROLLED_REBASELINE_EXECUTION_RESULT_AND_0389_HANDOFF_v0_5.md`, teste `platform-access.test.ts` | Falta apply controlado da `0389`, dual-read em ambiente aprovado e remocao futura do fallback `userId===1` | Aplicar `0389` em janela controlada | GPT-5.5 Altissimo |
| RBAC-04 | RBAC_SUPORTE | Suporte sem audit trail formal próprio | S2 | READY_FOR_CONTROLLED_SCHEMA_MIGRATION | Sprint O documentou `SUPPORT_ACCESS`; a etapa atual versionou `support_access_sessions` e helper pequeno de dual-audit legado + v2; `MIG-01` agora deixou baseline controlado validado para o apply da `0389` | `0389` local-only, MIG01 Controlled Rebaseline | — | Docs `AIRTRUST_SUPPORT_ACCESS_AUDIT_MODEL_v0_5.md`, `AIRTRUST_AUDIT_EVENT_TAXONOMY_v0_5.md`, `AIRTRUST_AUDIT_V2_RBAC_SUPPORT_SCHEMA_READINESS_v0_5.md`, `AIRTRUST_MIG01_CONTROLLED_REBASELINE_EXECUTION_RESULT_AND_0389_HANDOFF_v0_5.md`, teste `record-legacy-and-canonical-audit.test.ts` | Falta apply controlado da `0389`, call sites reais de sessao de suporte e ativacao operacional | Aplicar `0389` em janela controlada | GPT-5.5 Altissimo |
