-- AirTrust - SIGVOOS new environment bootstrap
-- Purpose: prepare a brand-new environment before historical migrations replay.
-- Scope: only the 3 SIGVOOS base tables and 4 indexes that must exist before
-- 0354_auditoria_critica_schema_hardening.sql reaches
-- ALTER TABLE integracoes_sigvoos_config ADD COLUMN notificar_falha_email TEXT.
-- No DML. No backfill. No secrets. No tenant seed data.
