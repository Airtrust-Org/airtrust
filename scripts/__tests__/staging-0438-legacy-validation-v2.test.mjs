...
// operational_decision: assertions inspect DML/text only to prove the compatibility runner exercises revision evidence and cleanup remains synthetic, dependency-aware, fail-closed and outside production/schema apply paths.
...
test('CAS compatibility runner is fail closed and exercises coordination etapa revisions', () => {
