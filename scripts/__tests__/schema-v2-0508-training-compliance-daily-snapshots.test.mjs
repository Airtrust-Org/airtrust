// source_reference: worker-airtrust/schema-v2/training-compliance-daily-snapshots-0508.json
// operational_decision: static/local governance test only; never writes to staging or production D1
// dry_run_required: true
// rollback_plan_required: worker-airtrust/schema-v2/plans/training-compliance-daily-snapshots-0508.md
...
const MANIFEST = 'worker-airtrust/schema-v2/training-compliance-daily-snapshots-0508.json';
const MIGRATION = 'worker-airtrust/migrations/0508_training_compliance_daily_snapshots.sql';
const CHANGE_ID = 'training-compliance-daily-snapshots-0508';
...
test('production workflow wires dedicated 0508 preflight and postconditions', () => {
  ...
  assert.match(workflow, /training-compliance-daily-snapshots-0508/);
...
test('staging allowlists 0508 through recovery-point runner and postconditions', () => {
  ...
  assert.match(outer, /0508_training_compliance_daily_snapshots\.sql/);
  assert.match(generic, /0508_training_compliance_daily_snapshots\.sql/);
