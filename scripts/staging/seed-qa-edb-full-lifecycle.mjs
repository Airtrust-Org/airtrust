...
function seedCanonicalFixture(dbName, id) {
  ...
  const flightCandidates = {
    ...
    aeronave_id: null,
    horario_previsto_partida: `${f.date}T10:10:00`,
    horario_previsto_chegada: `${f.date}T11:00:00`,
    horario_real_partida: `${f.date}T10:10:00`,
    horario_real_chegada: `${f.date}T11:00:00`,
    status: 'planejado',
    observacoes: id,
    versao: 1,
  ...
  const crewCandidates = {
    ...
    funcao: 'PIC',
    horario_apresentacao: `${f.date}T09:30:00`,
    horario_dispensa: `${f.date}T11:30:00`,
  ...
  const rdvCandidates = {
    ...
    numero: f.rdvNumber,
    data_voo: f.date,
    horario_decolagem_real: `${f.date}T10:10:00`,
    horario_pouso_real: `${f.date}T11:00:00`,
    horas_voadas: 0.83,
    numero_pousos: 1,
    ciclos: 1,
