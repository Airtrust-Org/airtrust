...
// A cleanup anterior pode ter apagado usuarios_empresas antes de falhar ao
// apagar usuarios. Por isso a recuperacao nao depende do vinculo: deriva os
// cinco emails EXATOS do provisionador para este runId e recusa qualquer outro.
