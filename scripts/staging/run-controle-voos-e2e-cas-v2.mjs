...
// overlay only exercises a coordination-time etapa edit so cv_rdv_revisoes
// receives real evidence. The canonical runner now owns stage discovery/update
// and exposes etapaId for this overlay. Product code is not modified.
