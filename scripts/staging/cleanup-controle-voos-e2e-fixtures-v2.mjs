...
async function main() {
  ...
  const statements = [
    ...
    // Login real do E2E persiste refresh tokens com FK direta para usuarios.
    ['refresh_tokens', `DELETE FROM refresh_tokens WHERE user_id IN (${userIdList});`],
    // Funcionarios criados pela API podem manter referencias ao usuario/setor;
    // os filhos precisam sair antes dos pais para o cleanup permanecer fail-closed.
