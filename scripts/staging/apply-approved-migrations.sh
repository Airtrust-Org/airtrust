...
RELEASE_PREFLIGHT_SCOPE="0421,0422,0423,0424,0425,0452,0453,0454,0457,0459,0467,0468,0469,0470,0472"
...
if [[ "$migration_basename" == "0467_sigvoos_shadow_parallel_v1.sql" || \
      ...
      "$migration_basename" == "0472_frms_operational_readiness.sql" ]]; then
