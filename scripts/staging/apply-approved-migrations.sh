...
if [[ "$migration_basename" == "0467_sigvoos_shadow_parallel_v1.sql" || \
      ...
      "$migration_basename" == "0469_lms_completion_pendencias_snapshots.sql" ]]; then
