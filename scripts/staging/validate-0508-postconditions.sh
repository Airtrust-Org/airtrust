...
assert_count migration-ledger 1 "SELECT COUNT(*) count FROM d1_migrations WHERE name='0508_controle_voos_flight_plan.sql';"
...
echo CONTROLE_VOOS_FLIGHT_PLAN_0508_STAGING_POSTCONDITIONS=PASS
