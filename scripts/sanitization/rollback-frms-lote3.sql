-- ============================================================
-- LOTE 3 ROLLBACK — frms_jornada sem tenant
-- Restaura explicitamente empresa_id = NULL para os 76 IDs do escopo automático.
-- ============================================================
...
-- Esperado: até 76 linhas afetadas, somente se o apply tiver sido executado.

SELECT
  COUNT(*) AS rollback_restaurou_null
FROM frms_jornada
