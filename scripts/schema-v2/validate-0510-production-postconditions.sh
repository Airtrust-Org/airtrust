...
[[ "$target" == "$ALLOWED_DB_NAME" ]] || { echo "ERROR: 0510 production postconditions refused target: $target" >&2; exit 1; }
...
echo CONTROLE_VOOS_PETROBRAS_RVE_EXPORT_0510_PRODUCTION_POSTCONDITIONS=PASS
