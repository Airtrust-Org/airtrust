...
CHANGE_ID="conhecimento-ativo-foundation-0502"
...
[[ "$target" == "$ALLOWED_DB_NAME" ]] || {
  echo "ERROR: 0502 production postconditions refused target: $target" >&2
  exit 1
}
...
echo CONHECIMENTO_ATIVO_FOUNDATION_0502_PRODUCTION_POSTCONDITIONS=PASS
