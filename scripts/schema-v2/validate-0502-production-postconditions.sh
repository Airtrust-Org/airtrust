...
[[ "$target" == "$ALLOWED_DB_NAME" ]] || { echo "ERROR: 0502 production postconditions refused target: $target" >&2; exit 1; }
...
echo CONTROLE_VOOS_FUELING_COMPANIES_0502_PRODUCTION_POSTCONDITIONS=PASS
