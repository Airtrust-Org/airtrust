...
[[ "$target" == "$ALLOWED_DB_NAME" ]] || { echo "ERROR: 0509 production postconditions refused target: $target" >&2; exit 1; }
...
echo CONTROLE_VOOS_FLIGHT_PLAN_0509_PRODUCTION_POSTCONDITIONS=PASS
