...
assert_count "merged-source-sectors-active" 0 "SELECT COUNT(*) AS count FROM setores WHERE empresa_id=6 AND id IN (15,21) AND deleted_at IS NULL AND COALESCE(ativo,1)=1;"
