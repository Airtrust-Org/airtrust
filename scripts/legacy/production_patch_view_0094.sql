-- Production Patch: View 0094 adiciona campos analíticos nulos (nota, instrutor, local_treinamento, modalidade, carga_horaria)
-- Run: wrangler d1 execute airtrust-db --remote --file production_patch_view_0094.sql
