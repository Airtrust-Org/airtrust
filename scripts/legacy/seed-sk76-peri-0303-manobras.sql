-- Seed corretivo: SK76 - PERIÓDICO - 03/03: LOFT E CHECK
-- Garante categorias, manobras e vínculos corretos para o modelo.

BEGIN TRANSACTION;

-- Categorias canônicas do LOFT/CHECK SK76
...
-- Manobras corretas do modelo 03/03 LOFT E CHECK
...
-- Força o conjunto exato de manobras do modelo, na ordem correta
