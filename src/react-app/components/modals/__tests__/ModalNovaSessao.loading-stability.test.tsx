...
describe('ModalNovaSessao loading stability', () => {
  ...
  it('mantem_apenas_o_resultado_da_ultima_combinacao_estavel_quando_ini_e_per_disparam_em_sequencia', async () => {
    ...
    await waitFor(() => {
      ...
      expect(optionLabels).toContain('S76-P-01/04-C1 - Ciclo 1 / VFR-emergências');
  ...
  it('nao_mistura_periodico_em_inicial_quando_tipo_legado_vem_ambiguo', async () => {
    ...
    await waitFor(() => {
      ...
      expect(optionLabels).not.toContain('S76-P-01/04-C1 - Ciclo 1 / VFR-emergências');
      expect(optionLabels).not.toContain('S76-P-02/04-C1 - Ciclo 1 / IFR-emergências');
    });
  });
