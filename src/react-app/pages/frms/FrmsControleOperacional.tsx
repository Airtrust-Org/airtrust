    ...
    <AppLayout>
      <main className="space-y-4">
        ...
        <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-6">
          ...
          <KpiTile
            label="Alertas"
            value={operationalSummary.alerts}
            tone={operationalSummary.alerts > 0 ? 'danger' : 'neutral'}
          />
          <KpiTile
          ...
          />
          <KpiTile
            label="Dados estimados/ausentes"
            value={operationalSummary.estimatedOrAbsent}
            tone={operationalSummary.estimatedOrAbsent > 0 ? 'warning' : 'neutral'}
          />
          <KpiTile
            label="Inconsistencias"
            value={operationalSummary.inconsistencies}
            tone={operationalSummary.inconsistencies > 0 ? 'danger' : 'neutral'}
          />
          <KpiTile
            label="Ciencia pendente"
            value={operationalSummary.pendingAck}
            tone={operationalSummary.pendingAck > 0 ? 'info' : 'neutral'}
          />
        </section>

        {/* ── Bloco 2: Heatmap operacional ───────────────────── */}
        ...
        {/* ── Bloco 3: Acumulado do tripulante selecionado ──── */}
        {selectedCrewInfo && (
        ...
        {/* ── Bloco 4: Lista de ação operacional ─────────────── */}
