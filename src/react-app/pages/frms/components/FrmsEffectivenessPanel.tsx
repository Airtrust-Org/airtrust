/**
 * FrmsEffectivenessPanel — Painel A: Score de Efetividade Científico (SAFTE-FAST)
...
export default function FrmsEffectivenessPanel({
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2" title={`Efetividade: ${pct.toFixed(1)}% — ${nivel}`}>
    ...
    <div className="rounded-xl border border-slate-200/50 bg-white/80 backdrop-blur-sm p-4 shadow-md">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-400 mt-1">Modelo SAFTE-FAST</p>
        </div>
      </div>
