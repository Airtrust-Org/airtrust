...
const PERMISSOES_DISPONIVEIS = [
  ...
  {
    grupo: 'Escalas',
    items: ['escalas.view', 'escalas.edit', 'escalas.create', 'escalas.delete', 'escalas.publish'],
  },
  {
    grupo: 'Controle de Voos',
    items: [
      'controle_voos.view',
      'controle_voos.edit',
      'controle_voos.sigvoos_preview',
      'voos.rdv.visualizar_proprio',
      'voos.rdv.criar_proprio',
      'voos.rdv.editar_rascunho_proprio',
      'voos.rdv.enviar',
      'voos.rdv.visualizar_todos',
      'voos.rdv.revisar',
      'voos.rdv.corrigir',
      'voos.rdv.devolver',
      'voos.rdv.aprovar_coordenacao',
      'voos.rdv.aprovar_comercial',
      'voos.rdv.reabrir',
  ...
  {
    grupo: 'FRMS',
    items: ['frms.view', 'frms.team.view', 'frms.edit', 'frms.checkin'],
  },
...
const PERM_LABELS: Record<string, string> = {
  'treinamentos.view': 'Exibir área de Treinamentos',
  ...
  'escalas.create': 'Criar escalas e alocações',
  'escalas.delete': 'Excluir itens da escala',
  'escalas.publish': 'Publicar escalas',
  'controle_voos.view': 'Ver Controle de Voos',
  'controle_voos.edit': 'Operar Controle de Voos',
  'controle_voos.sigvoos_preview': 'Executar prévias SIGVOOS',
  'voos.rdv.visualizar_proprio': 'Ver RDVs próprios',
  'voos.rdv.criar_proprio': 'Criar RDV próprio',
  'voos.rdv.editar_rascunho_proprio': 'Editar rascunho de RDV próprio',
  'voos.rdv.enviar': 'Enviar RDV',
  'voos.rdv.visualizar_todos': 'Ver todos os RDVs',
  'voos.rdv.revisar': 'Revisar RDVs',
  'voos.rdv.corrigir': 'Corrigir RDVs',
  'voos.rdv.devolver': 'Devolver RDVs',
  'voos.rdv.aprovar_coordenacao': 'Aprovar RDVs pela Coordenação',
  'voos.rdv.aprovar_comercial': 'Aprovar RDVs pelo Comercial',
  'voos.rdv.reabrir': 'Reabrir RDVs',
  'voos.rdv.exportar_petrobras': 'Exportar RDVs Petrobras',
  'voos.rdv.cancelar': 'Cancelar RDVs',
  'frms.view': 'Ver FRMS',
  'frms.team.view': 'Ver painel operacional da equipe',
  'frms.edit': 'Editar FRMS',
  'frms.checkin': 'Realizar check-in de fadiga',
  'sgso.view': 'Ver SGSO',
