...
export function buildHomeAccessCards(params: {
  ...
  // "Meus Voos" lista as atribuições e o Pilot App é a única tela de lançamento.
  if (isFlightCrewHome) {
    cards.push({
      icon: <PlaneTakeoff className="w-7 h-7" />,
      title: 'Meus Voos',
      description: 'Consulte os voos atribuídos a você e abra o Pilot App para fazer o lançamento.',
