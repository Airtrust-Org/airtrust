...
export function buildHomeAccessCards(params: {
  ...
  // "Meus Voos" leva ao Pilot App, que é a única tela de preenchimento operacional/offline.
  if (isFlightCrewHome) {
    cards.push({
      icon: <PlaneTakeoff className="w-7 h-7" />,
      title: 'Meus Voos',
      description: 'Consulte os voos atribuídos a você e abra o Pilot App para preencher offline.',
