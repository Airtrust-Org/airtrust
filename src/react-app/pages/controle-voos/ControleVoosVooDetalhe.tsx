          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-700 dark:bg-slate-900">
                ...
                <div className="space-y-2">
                  <button disabled className="w-full rounded-lg bg-slate-100 px-4 py-2 text-sm font-medium text-slate-400 cursor-not-allowed dark:bg-slate-800 dark:text-slate-500" title="Funcionalidade em desenvolvimento">Liberar Voo</button>
                  <button disabled className="w-full rounded-lg bg-slate-100 px-4 py-2 text-sm font-medium text-slate-400 cursor-not-allowed dark:bg-slate-800 dark:text-slate-500" title="Funcionalidade em desenvolvimento">Cancelar Voo</button>
                  <button disabled className="w-full rounded-lg bg-slate-100 px-4 py-2 text-sm font-medium text-slate-400 cursor-not-allowed dark:bg-slate-800 dark:text-slate-500" title="Funcionalidade em desenvolvimento">Alterar Tripulação</button>
                  <button disabled className="w-full rounded-lg bg-slate-100 px-4 py-2 text-sm font-medium text-slate-400 cursor-not-allowed dark:bg-slate-800 dark:text-slate-500" title="Funcionalidade em desenvolvimento">Atualizar Status</button>
                </div>
              </div>
            </div>
          </div>
