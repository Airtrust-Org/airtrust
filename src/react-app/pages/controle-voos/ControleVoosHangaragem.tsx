    ...
    <AppLayout>
      <div className="w-full">
        <ControleVoosPageShell>
          <ControleVoosPageHeader title="Hangaragem" description="Tela em preview. Ainda não existe tabela operacional real para hangaragem nem integração confiável com MRO nesta macroetapa.">
            <button
              disabled
