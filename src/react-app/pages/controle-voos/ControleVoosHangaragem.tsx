      ...
      <div className="w-full">
        <ControleVoosPageShell>
          <ControleVoosPageHeader title="Hangaragem" description="Ainda não existe tabela operacional real para hangaragem nem integração confiável com MRO nesta macroetapa.">
            <span className="inline-flex items-center gap-2 rounded-lg border border-dashed border-slate-300 bg-slate-50 px-4 py-2 text-sm font-medium text-slate-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400" aria-label="Cadastro de hangaragem indisponível neste preview">
