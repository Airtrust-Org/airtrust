    ...
    <AppLayout>
      <div className="w-full">
        <ControleVoosPageShell>
          <ControleVoosPageHeader title="Indisponibilidades de Aeronave" description="Tela em preview. Ainda não existe schema operacional consolidado para indisponibilidades por causa, grupo e período nesta macroetapa.">
            <button
              disabled
