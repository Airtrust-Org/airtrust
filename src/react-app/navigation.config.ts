...
export const NAVIGATION_CONFIG: NavigationStructure = {
  main_menu: [
    ...
    },
    {
      ...
      expandable: true,
      children: [
        { id: 'controle_voos-operacao', label: 'Operação', path: '/controle-voos' },
        { id: 'controle_voos-meus-voos', label: 'Meus voos', path: '/controle-voos/meus-voos' },
        {
          id: 'controle_voos-coordenacao',
          label: 'Coordenação',
          path: '/controle-voos/coordenacao/fila',
        },
        {
        ...
        { id: 'controle_voos-tabelas', label: 'Cadastros', path: '/controle-voos/tabelas' },
      ],
    },
  ],
  settings_menu: [
