...
describe('Pilot Offline shell', () => {
  ...
  it('captura quick actions de horario com sequencia monotona sem inferir ciclos', () => {
    ...
    expect(pilotApp).toContain("label: 'Peso dos passageiros'");
    expect(pilotApp).toContain("label: 'Peso da bagagem'");
    ...
    expect(pilotApp).toContain("input.step = 'any'");
    ...
    expect(pilotApp).toContain("label: 'Peso total'");
  ...
  it('expõe tempos derivados, unidades e erro real da transmissão bloqueada', () => {
    ...
    expect(pilotApp).toContain('kg são convertidos automaticamente');
    expect(pilotApp).toContain('Hora de apresentação: ');
